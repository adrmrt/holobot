...
public class MangaSearchCmd implements CommandMetadata, ExecutableCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(MangaSearchCmd.class);
